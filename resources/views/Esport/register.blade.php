...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <div class="registration-rules-container" style="background-color: rgba(245, 204, 131, 0.5); padding: 20px; border-radius: 8px; margin-bottom: 20px;">
            ...
            <ol style="color: white; font-size: 20px;">
                <li>Download Formulir Pendaftaran di sini:
                    ...
                    <a href="https://docs.google.com/document/d/1ejmUaSkoenIK5IdSMoxotRh5edxnO9g2/edit?usp=drive_link" class="btn btn-primary" style="margin-top: 10px;">Download Formulir</a>
                </li>
        ...
        <h2>Form Daftar Esport</h2>
        <form action="{{ route('register.esport') }}" method="post" enctype="multipart/form-data">
