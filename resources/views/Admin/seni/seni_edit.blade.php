    ...
    <div class="card">
        <div class="card-body">
            <div class="container-fluid">
                <h2 class="text-center">Edit Seni</h2><br>
                <form action="{{ route('admin.updateSeni', ['id' => $seni->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="cabang" name="cabang" rows="3">{{ $seni->cabang }}</textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="revisi" name="revisi" rows="3">{{ $seni->revisi }}</textarea>
                        </div>
                    </div>
