    ...
    <div class="card">
        <div class="card-body">
            <div class="container-fluid">
                <h2 class="text-center">Data Cabang Seni (Cerpen)</h2><br>
                        ...
                        <tbody>
                            @foreach ($cerpen as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ asset('cerpen/files/' . $data->file) }}" style="color: white; text-decoration: none;">
                                            <button type="button" class="btn btn-success text-white"> View </button>
                                        </a>
                                        &nbsp; <!-- Menambahkan spasi antara tombol -->
                                        <a href="{{ asset('cerpen/files/' . $data->file) }}" download="{{ $data->file }}"
                                           >
                            ...
                            <div class="modal fade" id="deleteModal{{ $data->id }}" tabindex="-1" aria-labelledby="deleteModalLabel"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form id="deleteForm" action="{{ route('admin.deleteCerpen',['id' => $data->id]) }}" method="POST">
