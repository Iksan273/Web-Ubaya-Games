    ...
    <div class="card">
        <div class="card-body">
            <div class="container-fluid">
                <h2 class="text-center">Edit Badminton</h2><br>
                <form action="{{ route('admin.updateBadminton', ['id' => $badminton->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputPosition" name="nama_kontingen"
                                value="{{ $badminton->nama_kontingen }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="revisi" name="revisi" rows="3">{{ $badminton->revisi }}</textarea>
                        </div>
                    </div>
