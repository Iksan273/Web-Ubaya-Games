    ...
    <div class="card">
        <div class="card-body">
            <div class="container-fluid">
                <h2 class="text-center">Data Cabang Futsal</h2><br>
                        ...
                        <tbody>
                            @foreach ($futsal as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.editFutsal',['id'=>$data->id]) }}"><button class="btn btn-primary btn-sm"
                            ...
                            <div class="modal fade" id="deleteModal{{ $data->id }}" tabindex="-1" aria-labelledby="deleteModalLabel"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form id="deleteForm" action="{{ route('admin.deleteFutsal',['id' => $data->id]) }}" method="POST">
