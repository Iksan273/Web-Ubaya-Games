    ...
    <div class="card">
        <div class="card-body">
            <div class="container-fluid">
                <h2 class="text-center">Edit Esport</h2><br>
                <form action="{{ route('admin.updateEsport', ['id' => $esport->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="revisi" name="revisi" rows="3">{{ $esport->revisi }}</textarea>
                        </div>
                    </div>
