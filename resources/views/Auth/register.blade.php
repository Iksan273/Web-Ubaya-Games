...
<body>
    ...
    <div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <p class="auth-description">Register<br>Already have an account?
                <a href="{{ route('login.form') }}">Sign In</a>
            </p>

            <form method="POST" action="{{ route('register') }}" class="auth-credentials m-b-xxl">
                @csrf
                <label for="signUpUsername" class="form-label">Name</label>
                <input type="text" name="name" class="form-control m-b-md" placeholder="Enter Name" required
                    name="name">

                <label for="signUpEmail" class="form-label">Email address</label>
                <input type="email" name="email" class="form-control m-b-md" required name="email"
